...
CREATE TABLE [web].[WPersonalDataPage](
 ...
 CONSTRAINT [PK_WPersonalDataPage] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
CREATE TABLE [web].[WGender](
	[Id] [BIGINT] IDENTITY(1,1) NOT NULL,
	[Name] [VARCHAR](100) NOT NULL,
	[Active] [BIT] NOT NULL,
 CONSTRAINT [PK_WGender] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
