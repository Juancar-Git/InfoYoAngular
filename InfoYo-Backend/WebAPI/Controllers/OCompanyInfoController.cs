...
namespace WebAPI.Controllers
{
    ...
    public class OCompanyInfoInfoController : ApiController
    {
        ...
        {
            var response = new ResponseVMR<List<OCompanyInfoVMR>>();

            try
            {
                response.data = OCompanyInfoBLL.ReadByCompanyId(id);
            }
            catch (Exception e)
            {
        ...
        public IHttpActionResult ReadOne(long id)
        {
            ...
            var response = new ResponseVMR<OCompanyInfoVMR>();

            try
            {
                response.data = OCompanyInfoBLL.ReadOne(id);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        [HttpPost]
        public IHttpActionResult Create(OCompanyInfo item)
        {
            var response = new ResponseVMR<long?>();

            try
            {
                response.data = OCompanyInfoBLL.Create(item);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        [HttpPut]
        public IHttpActionResult Update(long id, OCompanyInfoVMR item)
        {
