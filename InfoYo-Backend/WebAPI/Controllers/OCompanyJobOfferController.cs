...
namespace WebAPI.Controllers
{
    ...
    public class OCompanyJobOfferController : ApiController
    {
        ...
        {
            var response = new ResponseVMR<List<OCompanyJobOfferVMR>>();

            try
            {
                response.data = OCompanyJobOfferBLL.ReadByCompanyId(id);
            }
            catch (Exception e)
            {
        ...
        public IHttpActionResult ReadOne(long id)
        {
            ...
            var response = new ResponseVMR<OCompanyJobOfferVMR>();

            try
            {
                response.data = OCompanyJobOfferBLL.ReadOne(id);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        [HttpPost]
        public IHttpActionResult Create(OCompanyJobOffer item)
        {
            var response = new ResponseVMR<long?>();

            try
            {
                response.data = OCompanyJobOfferBLL.Create(item);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        [HttpPut]
        public IHttpActionResult Update(long id, OCompanyJobOfferVMR item)
        {
            ...
            {
                item.Id = id;
                OCompanyJobOfferBLL.Update(item);
                response.data = true;
            }
            catch (Exception e)
            {
