...
namespace WebAPI.Controllers
{
    ...
    public class OCvVisitController : ApiController
    {
        ...
        {
            var response = new ResponseVMR<List<OCvVisitVMR>>();

            try
            {
                response.data = OCvVisitBLL.ReadByCompanyId(id);
            }
            catch (Exception e)
            {
        ...
        public IHttpActionResult ReadByPersonId(long id)
        {
            ...
            try
            {
                response.data = OCvVisitBLL.ReadByPersonId(id);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        public IHttpActionResult ReadOne(long id)
        {
            ...
            var response = new ResponseVMR<OCvVisitVMR>();

            try
            {
                response.data = OCvVisitBLL.ReadOne(id);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        [HttpPost]
        public IHttpActionResult Create(OCvVisit item)
        {
            var response = new ResponseVMR<long?>();

            try
            {
                response.data = OCvVisitBLL.Create(item);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
        ...
        [HttpPut]
        public IHttpActionResult Update(long id, OCvVisitVMR item)
        {
