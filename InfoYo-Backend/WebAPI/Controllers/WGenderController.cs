...
namespace WebAPI.Controllers
{
    ...
    public class WGenderController : ApiController
    {
        [HttpGet]
        public IHttpActionResult ReadAll()
        {
            var response = new ResponseVMR<List< WGenderVMR>>();

            try
            {
                response.data =  WGenderBLL.ReadAll();
            }
            catch (Exception e)
            {
        ...
        public IHttpActionResult ReadOne(long id)
        {
            ...
            var response = new ResponseVMR< WGenderVMR>();

            try
            {
                response.data =  WGenderBLL.ReadOne(id);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
