...
namespace WebAPI.Controllers
{
    ...
    public class WLogNavBarLinkController : ApiController
    {
        ...
        {
            var response = new ResponseVMR<List<WLogNavBarLinkVMR>>();

            try
            {
                response.data = WLogNavBarLinkBLL.ReadAll();
            }
            catch (Exception e)
            {
        ...
        public IHttpActionResult ReadOne(long id)
        {
            ...
            var response = new ResponseVMR<WLogNavBarLinkVMR>();

            try
            {
                response.data = WLogNavBarLinkBLL.ReadOne(id);
            }
            catch (Exception e)
            {
                response.code = HttpStatusCode.InternalServerError;
